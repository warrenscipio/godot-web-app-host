...
/** @type {string} */
const CACHE_VERSION = '1737675457|13741590039';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["web-project.html","web-project.js","web-project.offline.html","web-project.icon.png","web-project.apple-touch-icon.png","web-project.worker.js","web-project.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["web-project.wasm","web-project.pck"];
