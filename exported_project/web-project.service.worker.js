...
/** @type {string} */
const CACHE_VERSION = '1741125393|3029130793';
/** @type {string} */
const CACHE_PREFIX = 'web-project-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'web-project.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["web-project.html","web-project.js","web-project.offline.html","web-project.icon.png","web-project.apple-touch-icon.png","web-project.audio.worklet.js","web-project.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["web-project.wasm","web-project.pck"];
